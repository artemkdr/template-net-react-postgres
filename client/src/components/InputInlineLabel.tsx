...
export const InputInlineLabel: React.FC<InputInlineLabelProps> = (props) => {
    ...
    return (
        <InputGroup {...rest}>
            <InputLeftAddon width="40%" whiteSpace="initial" textAlign={"right"} textOverflow="ellipsis" overflow={"hidden"} justifyContent="end" fontWeight="bold" textTransform="uppercase" fontSize="10px">{label}</InputLeftAddon>
            {input}
        </InputGroup>
    )
}